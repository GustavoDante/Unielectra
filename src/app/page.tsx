    ...
    <div className="w-full space-y-10">
      ...
      <section className="grid w-full max-w-7xl m-auto px-6">
        <div className="flex justify-between w-full">
          ...
          <Button className="bg-transparent text-black flex gap-1 hover:bg-slate-200">
            Ver mais
            <svg
              width="17"
              height="14"
        ...
        <div className="grid-cols-1 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-center">
          <ProductCard
            key={1}
      ...
      <section className="grid w-full max-w-7xl m-auto px-6">
        <div className="flex justify-between w-full">
          <h1 className="text-lg font-semibold">Mais vendidos</h1>
          <Button className="bg-transparent text-black flex gap-1 hover:bg-slate-200">
            Ver mais
            <svg
              width="17"
      ...
      <section className="grid w-full max-w-7xl m-auto px-6">
        <div className="flex justify-between w-full">
          <h1 className="text-lg font-semibold">Populares</h1>
          <Button className="bg-transparent text-black flex gap-1 hover:bg-slate-200">
            Ver mais
            <svg
              width="17"
